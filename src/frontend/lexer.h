...
struct ExpressionLexer {
    ...
    /**
     * @brief get pointer to buffered string of first char of current token
     *
     * @return Ele*
     */
    ...
    /**
     * @brief get pointer to buffered string of end of current token
     *
     * @return Ele*
     */
    const Ele* nextPointer() const { return next; }
